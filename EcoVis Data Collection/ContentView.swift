    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 20) {
                    // Instruction
                    Text("Retake reference image each time you have rotated 90° around the object. Keep object centered within the region you selected in the reference image in each proceeding image to ensure best overlap detection results.")
